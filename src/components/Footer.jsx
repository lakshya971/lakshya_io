...
function Footer() {
    return (
        <div className='flex gap-5 w-full h-[140vh] bg-zinc-900 p-20'>
            <div className='w-1/2 h-full flex flex-col justify-between font-semibold '>
                <div className="heading">
                    <h1 className='text-[6vw] uppercase font-semibold tracking-tighter leading-none '>Eye-</h1>
                    <h1 className='text-[6vw] uppercase font-semibold tracking-tighter leading-none '>Opening</h1>
                </div>
            ...
            <div className='flex flex-col gap-28 w-1/2'>
                <h1 className='text-[5vw] uppercase font-semibold tracking-tighter leading-none '>
                    Presentations
                </h1>

                <div className='text-[2vw] font-normal text-gray-400 flex flex-col underline underline-offset-4 gap-2'>
                ...
                <div className='text-[2vw] font-normal text-gray-400 flex flex-col underline underline-offset-4 gap-2'>
                    ...
                    {["Home", "Services", "Our Work", "Insights", "Contact Us"].map((item, index) => {
                        ...
                        <p className='text-gray-500'>© ochi design 2025. Legal Terms</p>
                </div>
